...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractModel.reportNo'
        db.add_column(u'oai_abstractmodel', 'reportNo',
    ...
    def backwards(self, orm):
        # Deleting field 'AbstractModel.reportNo'
        db.delete_column(u'oai_abstractmodel', 'reportNo')
