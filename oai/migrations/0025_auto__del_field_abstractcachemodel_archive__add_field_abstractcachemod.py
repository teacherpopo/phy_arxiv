...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbstractCacheModel.archive'
        db.delete_column(u'oai_abstractcachemodel', 'archive')

        # Adding field 'AbstractCacheModel.archived'
        db.add_column(u'oai_abstractcachemodel', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AbstractCacheModel.archive'
        db.add_column(u'oai_abstractcachemodel', 'archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AbstractCacheModel.archived'
        db.delete_column(u'oai_abstractcachemodel', 'archived')
