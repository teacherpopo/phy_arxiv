...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbstractModel.cached'
        db.alter_column(u'oai_abstractmodel', 'cached', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'AbstractModel.archive'
        db.alter_column(u'oai_abstractmodel', 'archive', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'AbstractModel.cached'
        db.alter_column(u'oai_abstractmodel', 'cached', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AbstractModel.archive'
        db.alter_column(u'oai_abstractmodel', 'archive', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'oai.abstractmodel': {
            ...
            'abstract': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            'archive': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'authors': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
